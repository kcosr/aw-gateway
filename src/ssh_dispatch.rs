...
mod tests {
    ...
    fn rejects_malformed_session_id_actions() {
        ...
        for command in [
            ...
            "stop default --session-id",
            "stop --session-id abc --session-id def default",
            "stop first second --session-id abc",
            "remove default --session-id",
            "remove --session-id abc --session-id def default",
            "remove first second --session-id abc",
